...
FECHA_MINIMA = "2025-09-01"
ENERGIA_MINIMA = 1e-27
TIPO_RUPTURA = None
...
nx.draw_networkx_nodes(G, pos, node_color=colors, cmap=plt.cm.inferno, node_size=800, alpha=0.5)  # Transparencia activada
